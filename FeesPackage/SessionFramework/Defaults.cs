...
namespace FeesPackage.Session_Framework
{
    static class Defaults
    {
        ...
        /// </summary>
        public const string APPNAME = "FeesPackage";
        ...
        /// </summary>
        public static readonly Guid SUBSCRIBER_ID = new Guid("{20ad076d-0015-43e1-8be6-9e52299c8520}");

        /// <summary>
        /// the Registration Key for your application within the Microsoft Registry
        /// </summary>
        public const string REG_KEY = "Software\\IDN\\FeesPackage";
